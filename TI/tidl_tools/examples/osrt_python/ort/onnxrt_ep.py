...
parser.add_argument('-m','--models', action='append', default=['yolo'], help='Model name to be added to the list to run')
...
calib_images = ['../../../test_data/6.jpg',
                '../../../test_data/7.jpg']
class_test_images = ['../../../test_data/airshow.jpg']
od_test_images    = ['../../../test_data/6.jpg']
...
def infer_image(sess, image_files, config):
  ...
  print("output.shape:", output[0].shape, output)
