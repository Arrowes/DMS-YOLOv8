...
accuracy_level = 1
calibration_frames = 2  #2
calibration_iterations = 5  #5
...
"deny_list":"",#"Slice, Transpose, Split",   #"MaxPool"
    ...
    if(framework == "MMDetection"):
        ...
        for i in range(num_boxes):
            if(outputs[0][i][4] > 0.3) :
                ...
                draw.rectangle(((int(xmin), int(ymin)), (int(xmax), int(ymax))), outline='red', width=2)
