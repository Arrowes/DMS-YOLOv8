...
models_configs = {
    # ONNX RT OOB Models
    'yolo' : {
        'model_path' : os.path.join(models_base_path, 'yolox_s_ti_lite5.onnx'),
        ...
        'meta_layers_names_list' : os.path.join(models_base_path, 'yolox_s_ti_lite2.prototxt'),
         'session_name' : 'onnxrt' ,
        'meta_arch_type' : 6
    },
    'seed' : {
        'model_path' : os.path.join(models_base_path, 'seed_yolox_215_RGB_11.onnx'),
