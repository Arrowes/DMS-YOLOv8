...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', type=str, default=ROOT / 'weight/yolov8n.pt', help='initial weights path')
    parser.add_argument('--cfg', type=str, default='yolo/YOLOv8.yaml', help='model.yaml path')
    ...
    parser.add_argument('--name', default='yolov8', help='save to project/name') #########################3
