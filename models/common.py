...
class Detections:
    ...
    def save(self, save_dir='runs/detect/pcba2'):
        save_dir = increment_path(save_dir, exist_ok=save_dir != 'runs/detect/pcba2', mkdir=True)  # increment save_dir
        self.display(save=True, save_dir=save_dir)  # save results

    def crop(self, save=True, save_dir='runs/detect/pcba2'):
        save_dir = increment_path(save_dir, exist_ok=save_dir != 'runs/detect/pcba2', mkdir=True) if save else None
